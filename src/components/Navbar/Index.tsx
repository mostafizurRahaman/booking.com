   ...
   return (
      <div className="relative flex items-center justify-between h-20 bg-primary  text-black px-5  md:px-10 ">
         ...
         <div className="flex items-center  gap-3">
            <nav
               className={`absolute top-20 duration-500 transition-all h-screen bg-primary w-[200px] md:w-auto md:bg-transparent left-0 md:static flex flex-col z-[9999]   md:flex-row justify-start px-5 md:px-0 font-medium  md:items-center gap-5 ${
