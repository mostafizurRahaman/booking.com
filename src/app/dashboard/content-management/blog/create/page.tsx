...
import { usePostblogMutation } from "@/redux/api/contentApi";
import ImageUpload from "@/components/imageUpload";
const CreateUser = () => {
  const router = useRouter();
  const [postablog] = usePostblogMutation();
  ...
  const handleSubmit: OnSubmitType = async (e) => {
    e.preventDefault();
    const res: any = await postablog(formData);
    console.log("res", res);
    if (res?.data?._id) {
      Swal.fire("Good job!", "blog posted", "success");
